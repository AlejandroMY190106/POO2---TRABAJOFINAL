...
public class Tc_TecnicoVista extends JFrame {
    ...
    public Tc_TecnicoVista() {
        ...
        JLabel subTitulo = new JLabel("Panel del Técnico");
        ...
        JLabel descripcion = new JLabel("<html>Revise alertas,<br>consulte órdenes asignadas<br>y mantenga el sistema al día.</html>");
        ...
        btnVerOrdenes = crearBoton("Ver Órdenes de Trabajo");
        btnCerrarSesion = crearBoton("Cerrar Sesión", true);

        for (JButton btn : new JButton[]{btnVerAlertas, btnVerOrdenes, btnCerrarSesion}) {
    ...
    public JButton getBtnVerOrdenes() {
        return btnVerOrdenes;
    }
