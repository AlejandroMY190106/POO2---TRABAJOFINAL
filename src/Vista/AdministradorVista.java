...
public class AdministradorVista extends JFrame {
    ...
    public AdministradorVista() {
        ...
        JLabel subTitulo = new JLabel("Panel del Administrador");
        ...
        JLabel descripcion = new JLabel("<html>Administre usuarios,<br>revise reportes y controle<br>el sistema eficientemente.</html>");
        ...
        for (JButton btn : new JButton[]{btnGestionarUsuarios, btnVerReportes, btnCerrarSesion}) {
    ...
    private JButton crearBoton(String texto, boolean especial) {
        JButton boton = new JButton(texto) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                super.paintComponent(g); // Esto dibuja el texto y el contenido del botón
            }
